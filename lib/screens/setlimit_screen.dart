      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image:
                AssetImage('assets/images/bg.jpg'), // Updated background image
            fit: BoxFit.cover,
          ),
        ),
        child: Stack(
          children: [
            Container(
              color:
                  Colors.white.withOpacity(0.5), // White overlay with opacity
            ),
            Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      onEditingComplete: () =>
                          _onTextFieldEditingComplete('cash'),
                    ),
                    ...
                    TextField(
                      ...
                      keyboardType: TextInputType.number,
                      decoration: const InputDecoration(
                        labelText: 'Enter SUMI Inter-Account Transfer Limit',
                      ),
                      onChanged: (value) => _onLimitInputChanged(value, 'sumi'),
                      onEditingComplete: () =>
                          _onTextFieldEditingComplete('sumi'),
                    ),
                    const SizedBox(height: 10),
                    CustomSlider(
                    ...
                    TextField(
                      ...
                      keyboardType: TextInputType.number,
                      decoration: const InputDecoration(
                        labelText: 'Enter Interbank Transfer Limit',
                      ),
                      onChanged: (value) =>
                          _onLimitInputChanged(value, 'interbank'),
                      onEditingComplete: () =>
                    ...
                    TextField(
                      ...
                      onChanged: (value) =>
                          _onLimitInputChanged(value, 'debit'),
                      onEditingComplete: () =>
                          _onTextFieldEditingComplete('debit'),
                    ),
